...
public class OtpRequest {
    ...
    @Schema(description = "Merchant ID (0 for admin/merchant users or OTP by phone, >0 for specific merchant customers)", 
            example = "0", 
            allowableValues = {"0", "1", "2", "3"})
    private Integer merchantId = 0; // Default to 0 for general OTP requests
    ...
    private String otpType = "password_reset"; // Default to login
