...
public class RegisterRequest {
    ...
    @Schema(description = "Merchant ID", example = "1", required = true)
    @NotNull(message = "Merchant ID is required")
    @Min(value = 1, message = "Merchant ID must be positive")
    @JsonProperty("merchantId")
    private Integer merchantId;
    
    @Schema(description = "User type", example = "customer", allowableValues = {"super_admin", "merchant", "customer"})
    ...
    public void setUserType(String userType) { 
        this.userType = userType != null ? userType.trim().toLowerCase() : null; 
    }
