...
public interface SecurityService {
    boolean hasPermission(Integer userId, String permission, Integer merchantId);
    boolean hasRole(Integer userId, String role, Integer merchantId);
    ...
    boolean canAccessMerchant(String username, Integer merchantId);
