    ...
    public CacheManager cacheManager(RedisConnectionFactory redisConnectionFactory) {
        if (!redisEnabled) {
            ...
            return new org.springframework.cache.concurrent.ConcurrentMapCacheManager(
                "userRoles", "userPermissions", "merchantData", "otpValidation"
            );
        }
        ...
        cacheConfigurations.put("merchantData", defaultConfig.entryTtl(Duration.ofMinutes(15)));
        cacheConfigurations.put("otpValidation", defaultConfig.entryTtl(Duration.ofMinutes(5)));
